...
h <- SEtools::sechm(sem, g, top_annotation=c("treatment","genotype"), use_raster=TRUE,
...
h2 <- SEtools::sechm(sem, rest, top_annotation=c("treatment","genotype"), use_raster=TRUE,
               gaps_at=c("system"), breaks=0.98, row_names_gp = gpar(fontsize = 10.5),
...
h3b <- SEtools::sechm(sem, gi, use_raster=TRUE, top_annotation=c(), name="hm2", show_heatmap_legend=FALSE,
                   gaps_at=c("system"), breaks=0.98, row_names_gp = gpar(fontsize = 10.5),
...
h1b <- SEtools::sechm(sem, g, 
                     ...
                     row_title="ion\nchannels")
h3 <- SEtools::sechm(sem, setdiff(grep("^RPL|^RPS|^EIF",consistent,value=TRUE),c("RPS6KA1","EIF4H")), 
                     top_annotation=c(), use_raster=TRUE, gaps_at=c("system"),
                     breaks=0.99, row_names_gp = gpar(fontsize = 10),
...
sechm(SEs$RNA, ri, use_raster=TRUE, top_annotation=c(), assayName="log2FC",
