...
draw(sechm(se, WBSg1, assay="log2FC", sortRowsOn=NULL, cluster_rows=FALSE, gaps_at="Dataset",
      top_annotation=c("genotype"), breaks=0.99, row_names_gp=gpar(fontsize=10), anno_colors=list(genotype=WBScols), use_raster=TRUE, row_title="WBSCR genes ordered by genomic position",
