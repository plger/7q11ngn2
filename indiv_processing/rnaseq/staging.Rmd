...
h <- sechm(sem, grep("Unknown",row.names(sem),invert=TRUE,value=TRUE), assayName="cor", name="Pearson\ncorrelation",
      gaps_at = "Dataset", sortRowsOn = NULL, cluster_rows = FALSE, anno_columns="genotype",
      hmcols=viridisLite::viridis(100), anno_rows = "", row_names_gp = gpar(fontsize=10), use_raster=TRUE)
